...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {
		...
		//-1 dmemizin nedeni sayfalamaya sıfırdan başlaması >>yani 1 verdiğimizde1-1=0 döndürür
				
		return new SuccessDataResult<List<Product>>
		(this.productDao.findAll(pageable).getContent()); //page türünde datayı dönüştürdük
	}
	@Override
